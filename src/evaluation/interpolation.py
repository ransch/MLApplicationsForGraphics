...
def main():
    ...
    gen.load_state_dict(torch.load(settings.localModels / 'glo4 with noise/gen.pt'))
    embed.load_state_dict(torch.load(settings.localModels / 'glo4 with noise/latent.pt'))
